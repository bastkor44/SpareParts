...
<div className="p-4">
  ...
  Find high-quality spare parts for your two-wheelers and four-wheelers all in one place.
  From essential components to performance upgrades, we've got the parts you need to keep your vehicle running smoothly.
</p>
...
>
 ...
 <div className="min-h-screen bg-gray-50 px-6 py-12 flex flex-col items-center">
        ...
        {cards.map((card, index) => (
          <Link key={index} to={card.link}>
            <div className="bg-white rounded-xl shadow-md hover:shadow-xl overflow-hidden transform transition duration-500 hover:scale-110">
              ...
              />
              <div className="p-6">
                <h2 className="text-2xl font-semibold text-slate-800 mb-2">{card.title}</h2>
      ...
      <div className="bg-white py-12 px-6 md:px-12 mt-20 shadow-md	" id="contact">
  <div className="max-w-6xl mx-auto">
    <h2 className="text-3xl font-bold text-center text-slate-800 mb-6">
      Get in Touch With Us
    </h2>
    <p className="text-center text-gray-600 mb-10 max-w-2xl mx-auto">
      Have a question about spare parts, orders, or services? Our team is here to help you with the right solutions for your two-wheeler and four-wheeler needs.
    </p>
    ...
    <div className="grid md:grid-cols-2 gap-10">
      ...
      <div className="space-y-6">
        <div>
          <h3 className="text-xl font-semibold text-slate-700">📍 Our Address</h3>
          <p className="text-gray-600">123 Auto Street, Spare City, IN 560001</p>
        </div>
        <div>
          <h3 className="text-xl font-semibold text-slate-700">📞 Call Us</h3>
          <p className="text-gray-600">+91 98765 43210</p>
        </div>
        <div>
          <h3 className="text-xl font-semibold text-slate-700">✉️ Email</h3>
          <p className="text-gray-600">support@sparemart.com</p>
        </div>
        <div>
