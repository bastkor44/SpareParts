  ...
  return (
    <div>
      ...
      <main className="px-4 md:px-8 py-10">
        <h2 className="text-2xl font-bold text-gray-700 mb-6 text-center">Manage Listing</h2>

        {/* Create Listing & Add Category Buttons */}
        <div className="flex justify-center gap-4 mb-8">
          <button
            onClick={() => navigate("/managerboard/createlisting")}
            className="bg-slate-500 text-white px-6 py-3 rounded-md shadow hover:bg-slate-800 transition-all"
          >
            Create Listing
          </button>
          <button
            onClick={() => navigate("/managerboard/addcategory")}
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full bg-white shadow-md rounded-xl overflow-hidden border border-gray-200">
              <thead className="bg-slate-100">
                <tr>
                  <th className="py-3 px-4 text-left text-gray-600 font-bold">Product ID</th>
                  <th className="py-3 px-4 text-left text-gray-600 font-bold">Image</th>
                  <th className="py-3 px-4 text-left text-gray-600 font-bold">Name</th>
                  <th className="py-3 px-4 text-left text-gray-600 font-bold">Description</th>
                  <th className="py-3 px-4 text-left text-gray-600 font-bold">Vehicle Type</th>
                  <th className="py-3 px-4 text-left text-gray-600 font-bold">Category</th>
                  <th className="py-3 px-4 text-left text-gray-600 font-bold">Price</th>
                  <th className="py-3 px-4 text-left text-gray-600 font-bold">Stock</th>
